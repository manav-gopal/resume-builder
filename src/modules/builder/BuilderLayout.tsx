  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <main className="flex w-full flex-row max-h-[calc(100vh_-_3.5rem)] print:max-h-fit">
        <div className="flex flex-col flex-1 sm:w-[100%] lg:w-[75%] justify-center bg-custom-grey100 overflow-hidden print:bg-white">
          ...
          >
            ...
            <Drawer
              ...
              sx={{
                ...
                '& .MuiDrawer-paper': { boxSizing: 'border-box', width: '100%' }, // fixed width for larger screens
              }}
              anchor="right"
              open
            >
