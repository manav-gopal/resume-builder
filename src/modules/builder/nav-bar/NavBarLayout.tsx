...
const NavBarLayout = () => {
  ...
  return (
    <nav className="h-14 w-full bg-[#2E4052] backdrop-blur-sm relative flex py-2.5 pl-5 pr-4 items-center shadow-level-8dp z-20 print:hidden">
      <Link href="/">
        <Image className='inline-block' src={'/icons/resume-icon.png'} alt="logo" height="36" width="36" />
      </Link>
